...
| `wi-roadmap-historical-count-reconciliation` | Reconcile the stale historical archive-count handoff and current snapshot | Completed | `.ai/work-items/archive/2026/wi-roadmap-historical-count-reconciliation.*` |
| `wi-archive-transaction-recovery` | Weekly Radar archive transaction recovery and logical commit boundary | Completed | `.ai/work-items/archive/2026/wi-archive-transaction-recovery.*` |
| `wi-capability-overview` | Capability overview and documentation navigation | Completed | `.ai/work-items/archive/2026/wi-capability-overview.*` |
| `wi-user-facing-capability-guide` | Rewrite the capability guide for user goals and detailed links | Completed | `.ai/work-items/archive/2026/wi-user-facing-capability-guide.*` |
| `wi-roadmap-post-capability-reconciliation` | Reconcile the roadmap after archive recovery and user-facing capability documentation | Completed | `.ai/work-items/archive/2026/wi-roadmap-post-capability-reconciliation.*` |
